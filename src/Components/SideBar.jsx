  ...
  return (
    <div className="bg-[#121212] text-white">
      <div className="z-50 bg-[#121212]">
        <aside className="fixed inset-x-0 bottom-0 z-40 w-full border-t border-white bg-[#121212] sm:inset-y-0 sm:left-0 sm:top-[82px] sm:h-[calc(100vh-82px)] sm:w-[70px] sm:border-r sm:border-t-0 sm:hover:w-[250px] sm:hover:transition-all">
