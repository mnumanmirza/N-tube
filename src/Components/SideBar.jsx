...
function SideBar() {
  ...
  return (
    <div className="bg-[#121212] text-white">
      <div className="z-50 bg-[#121212]">
        <aside className="group fixed inset-x-0 bottom-0 z-40 w-full border-t border-white bg-[#121212] transition-all duration-300 sm:inset-y-0 sm:left-0 sm:top-[82px] sm:h-[calc(100vh-82px)] sm:w-[70px] sm:border-r sm:border-t-0 sm:hover:w-[250px] sm:hover:transition-all">
          <ul className="flex justify-around gap-y-2 sm:sticky sm:top-[106px] sm:min-h-[calc(100vh-130px)] sm:flex-col">
            {/* Home - always visible */}
            <li>
              <button className="flex w-full items-center justify-center border-white py-1 focus:text-[#ae7aff] sm:flex-row sm:border sm:p-1.5 sm:hover:bg-[#ae7aff] sm:hover:text-black sm:focus:border-[#ae7aff] sm:focus:bg-[#ae7aff]">
                <Link to="/" className="flex w-full flex-col sm:flex-row items-center justify-center sm:justify-start gap-1 sm:gap-4 px-4">
                  ...
                  <span className="text-sm sm:opacity-0 sm:transition-opacity sm:duration-300 sm:group-hover:opacity-100 whitespace-nowrap">
                    Home
                  </span>
                </Link>
              </button>
            ...
            {/* Only show below items if logged in */}
            {isLoggedIn && (
              <>
                <li>
                  <button className="flex w-full items-center justify-center border-white py-1 focus:text-[#ae7aff] sm:flex-row sm:border sm:p-1.5 sm:hover:bg-[#ae7aff] sm:hover:text-black sm:focus:border-[#ae7aff] sm:focus:bg-[#ae7aff]">
                    <Link to="/LikeVideo" className="flex w-full flex-col sm:flex-row items-center justify-center sm:justify-start gap-1 sm:gap-4 px-4">
                      <span className="inline-block w-5 shrink-0">
                        <svg
                          viewBox="0 0 22 22"
                          fill="none"
                        ...
                        >
                          <path
                            d="M6 21V10M1 12V19C1 20.1046 1.89543 21 3 21H16.4262C17.907 21 18.1662 19.9197 18.3914 18.4562L19.4683 11.4562C19.7479 9.6389 18.3418 8 16.5032 8H14C13.4477 8 13 7.55228 13 7V3.46584C13 2.10399 11.896 1 10.5342 1C10.2093 1 9.91498 1.1913 9.78306 1.48812L6.26394 9.40614C6.10344 9.76727 5.74532 10 5.35013 10H3C1.89543 10 1 10.8954 1 12Z"
                            stroke="currentColor"
                            strokeWidth="2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                ...
                <li>
                  <button className="flex w-full items-center justify-center border-white py-1 focus:text-[#ae7aff] sm:flex-row sm:border sm:p-1.5 sm:hover:bg-[#ae7aff] sm:hover:text-black sm:focus:border-[#ae7aff] sm:focus:bg-[#ae7aff]">
                    <Link to="/History" className="flex w-full flex-col sm:flex-row items-center justify-center sm:justify-start gap-1 sm:gap-4 px-4">
                      <span className="inline-block w-5 shrink-0">
                        <svg
                          viewBox="0 0 22 20"
                          fill="none"
                ...
                <li className="hidden sm:block">
                  <button className="flex w-full items-center justify-center border-white py-1 focus:text-[#ae7aff] sm:flex-row sm:border sm:p-1.5 sm:hover:bg-[#ae7aff] sm:hover:text-black sm:focus:border-[#ae7aff] sm:focus:bg-[#ae7aff]">
                    <Link to="/MyContent" className="flex w-full flex-col sm:flex-row items-center justify-center sm:justify-start gap-1 sm:gap-4 px-4">
                      <span className="inline-block w-5 shrink-0">
                        <svg
                          viewBox="0 0 22 16"
                          fill="none"
                ...
                <li>
                  <button className="flex w-full items-center justify-center border-white py-1 focus:text-[#ae7aff] sm:flex-row sm:border sm:p-1.5 sm:hover:bg-[#ae7aff] sm:hover:text-black sm:focus:border-[#ae7aff] sm:focus:bg-[#ae7aff]">
                    <Link to="/MyCollection" className="flex w-full flex-col sm:flex-row items-center justify-center sm:justify-start gap-1 sm:gap-4 px-4">
                      <span className="inline-block w-5 shrink-0">
                        <svg
                          viewBox="0 0 22 20"
                          fill="none"
                ...
                <li>
                  <button className="flex w-full items-center justify-center border-white py-1 focus:text-[#ae7aff] sm:flex-row sm:border sm:p-1.5 sm:hover:bg-[#ae7aff] sm:hover:text-black sm:focus:border-[#ae7aff] sm:focus:bg-[#ae7aff]">
                    <Link to="/Subscribers" className="flex w-full flex-col sm:flex-row items-center justify-center sm:justify-start gap-1 sm:gap-4 px-4">
                      <span className="inline-block w-5 shrink-0">
                        <svg
                          viewBox="0 0 22 20"
                          fill="none"
                ...
                <li className="hidden sm:block mt-auto">
                  <button className="flex w-full items-center justify-center border-white py-1 focus:text-[#ae7aff] sm:flex-row sm:border sm:p-1.5 sm:hover:bg-[#ae7aff] sm:hover:text-black sm:focus:border-[#ae7aff] sm:focus:bg-[#ae7aff]">
                    <span className="flex w-full flex-col sm:flex-row items-center justify-center sm:justify-start gap-1 sm:gap-4 px-4">
                      <span className="inline-block w-5 shrink-0">
                        <svg
                          viewBox="0 0 22 22"
                          fill="none"
