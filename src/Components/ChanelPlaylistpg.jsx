                        ...
                        <div className="px-4 pb-4">
                            ...
                            <ul
                                ...
                                <li className="w-full">
                                    <Link to="/MyChanelEmptypg">
                                        <button
                                            className="w-full border-b-2 border-transparent px-3 py-1.5 text-gray-400">Videos</button></Link>
                                </li>
                                ...
                                <li className="w-full"> <Link to="/ChanelSubscribeList">
                                    <button
                            ...
                            <div className="grid gap-4 pt-2 sm:grid-cols-[repeat(auto-fit,_minmax(400px,_1fr))]">
                                <div className="w-full">
                                    ...
                                    <p className="flex text-sm text-gray-200">Master the art of building dynamic user interfaces
                                        with React.</p>
                                </div>
                                <div className="w-full">
                                    <div className="relative mb-2 w-full pt-[56%]">
                                        <div className="absolute inset-0"><img
                                            ...
                                            alt="JavaScript Fundamentals" className="h-full w-full" />
                                            <div className="absolute inset-x-0 bottom-0">
                                                <div
                                                    className="relative border-t bg-white/30 p-4 text-white backdrop-blur-sm before:absolute before:inset-0 before:bg-black/40">
                                                    <div className="relative z-[1]">
                                                        <p className="flex justify-between"><span
                                                            className="inline-block">Playlist</span><span
                                                                className="inline-block">1 videos</span></p>
                                    ...
                                    <p className="flex text-sm text-gray-200">Learn the core concepts and fundamentals of JavaScript
                                ...
                                <div className="w-full">
                                    <div className="relative mb-2 w-full pt-[56%]">
                                        <div className="absolute inset-0"><img
                                            ...
                                            alt="TypeScript Essentials" className="h-full w-full" />
                                            <div className="absolute inset-x-0 bottom-0">
                                                <div
                                                    className="relative border-t bg-white/30 p-4 text-white backdrop-blur-sm before:absolute before:inset-0 before:bg-black/40">
                                                    <div className="relative z-[1]">
                                                        <p className="flex justify-between"><span
                                                            className="inline-block">Playlist</span><span
                                                                className="inline-block">2 videos</span></p>
                                    ...
                                    <p className="flex text-sm text-gray-200">Dive into TypeScript for enhanced type safety and
                                        scalable JavaScript applications.</p>
                                </div>
                                <div className="w-full">
                                    <div className="relative mb-2 w-full pt-[56%]">
                                        <div className="absolute inset-0"><img
                                            src="https://images.pexels.com/photos/1144256/pexels-photo-1144256.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                            alt="React State Management" className="h-full w-full" />
                                            <div className="absolute inset-x-0 bottom-0">
                                                <div
                                                    className="relative border-t bg-white/30 p-4 text-white backdrop-blur-sm before:absolute before:inset-0 before:bg-black/40">
                                                    <div className="relative z-[1]">
                                    ...
                                    <p className="flex text-sm text-gray-200">Explore various state management techniques in React
                                        applications.</p>
                                </div>
                                <div className="w-full">
                                    <div className="relative mb-2 w-full pt-[56%]">
                                        <div className="absolute inset-0"><img
                                            ...
                                            alt="Advanced JavaScript Techniques" className="h-full w-full" />
                                            <div className="absolute inset-x-0 bottom-0">
                                                <div
                                                    className="relative border-t bg-white/30 p-4 text-white backdrop-blur-sm before:absolute before:inset-0 before:bg-black/40">
                                                    <div className="relative z-[1]">
                                    ...
                                    <p className="flex text-sm text-gray-200">Delve into advanced JavaScript concepts and techniques
                                        for professional-level programming.</p>
                                </div>
                            </div>
                        </div>
                    </section>
...
export default ChanelPlaylistpg
