...
function ChanelPlaylistVideopg() {
  return (
    <>
    <SideBar/>
      <div className=" bg-[#121212] text-white">
        <div className="flex min-h-[calc(100vh-66px)] sm:min-h-[calc(100vh-82px)]">
            <section className="w-full pl pl-4 pb-4 sm:pr-3 sm:pl-0 sm:pb-6 md:pl-8 md:pb-8 lg:pl-12 lg:pb-12 xl:pl-16 xl:pb-16">
                <div className="flex flex-wrap gap-x-4 gap-y-10 p-4 xl:flex-nowrap">
                    <div className="w-full shrink-0 sm:max-w-md xl:max-w-sm">
                        <div className="relative mb-2 w-full pt-[56%]">
                            <div className="absolute inset-0"><img
                                    src="https://images.pexels.com/photos/3561339/pexels-photo-3561339.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                    alt="React Mastery" className="h-full w-full" />
                                <div className="absolute inset-x-0 bottom-0">
                                    <div
                                        className="relative border-t bg-white/30 p-4 text-white backdrop-blur-sm before:absolute before:inset-0 before:bg-black/40">
                                        <div className="relative z-[1]">
                                            <p className="flex justify-between"><span
                                                    className="inline-block">Playlist</span><span
                                                    className="inline-block">12 videos</span></p>
                        ...
                        <p className="flex text-sm text-gray-200">Master the art of building dynamic user interfaces with
                            React.</p>
                        <div className="mt-6 flex items-center gap-x-3">
                            <div className="h-16 w-16 shrink-0"><img
                        ...
                        <div className="border">
                            <div className="w-full max-w-3xl gap-x-4 sm:flex">
                                ...
                                <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                                    <div className="h-10 w-10 shrink-0 sm:hidden"><img
                                    ...
                                    <div className="w-full">
                                        <h6 className="mb-1 font-semibold sm:max-w-[75%]">JavaScript Fundamentals: Variables
                                            and Data Types</h6>
                                        <p className="flex text-sm text-gray-200 sm:mt-3">10.3k Views · 44 minutes ago</p>
                                        <div className="flex items-center gap-x-4">
                                            <div className="mt-2 hidden h-10 w-10 shrink-0 sm:block"><img
                                                    src="https://images.pexels.com/photos/3532545/pexels-photo-3532545.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                                    alt="codemaster" className="h-full w-full rounded-full" /></div>
                        ...
                        <div className="border">
                            <div className="w-full max-w-3xl gap-x-4 sm:flex">
                                <div className="relative mb-2 w-full sm:mb-0 sm:w-5/12">
                                    <div className="w-full pt-[56%]">
                                        <div className="absolute inset-0"><img
                                                ...
                                                alt="Getting Started with Express.js" className="h-full w-full" /></div>
                                        <span
                                ...
                                <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                                    ...
                                    <div className="w-full">
                                        <h6 className="mb-1 font-semibold sm:max-w-[75%]">Getting Started with Express.js
                                        </h6>
                        ...
                        <div className="border">
                            <div className="w-full max-w-3xl gap-x-4 sm:flex">
                                ...
                                <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                                    ...
                                    <div className="w-full">
                                        <h6 className="mb-1 font-semibold sm:max-w-[75%]">Building a RESTful API with
                                            Node.js and Express</h6>
                        ...
                        <div className="border">
                            <div className="w-full max-w-3xl gap-x-4 sm:flex">
                                ...
                                <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                                    ...
                                    <div className="w-full">
                                        <h6 className="mb-1 font-semibold sm:max-w-[75%]">Creating Custom Hooks in React
                                        </h6>
                        ...
                        <div className="border">
                            <div className="w-full max-w-3xl gap-x-4 sm:flex">
                                ...
                                <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                                    ...
                                    <div className="w-full">
                                        <h6 className="mb-1 font-semibold sm:max-w-[75%]">Building Scalable Web Applications
                                            with Django</h6>
                        ...
                        <div className="border">
                            <div className="w-full max-w-3xl gap-x-4 sm:flex">
                                ...
                                <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                                    ...
                                    <div className="w-full">
                                        <h6 className="mb-1 font-semibold sm:max-w-[75%]">Creating Interactive UIs with
                                            React and D3</h6>
                        ...
                        <div className="border">
                            <div className="w-full max-w-3xl gap-x-4 sm:flex">
                                <div className="relative mb-2 w-full sm:mb-0 sm:w-5/12">
                                    <div className="w-full pt-[56%]">
                                        <div className="absolute inset-0"><img
                                                ...
                                                alt="Node.js Authentication with Passport.js" className="h-full w-full" />
                                        </div><span
                                ...
                                <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                                    ...
                                    <div className="w-full">
                                        <h6 className="mb-1 font-semibold sm:max-w-[75%]">Node.js Authentication with
                                            Passport.js</h6>
                        ...
                        <div className="border">
                            <div className="w-full max-w-3xl gap-x-4 sm:flex">
                                <div className="relative mb-2 w-full sm:mb-0 sm:w-5/12">
                                    <div className="w-full pt-[56%]">
                                        <div className="absolute inset-0"><img
                                                ...
                                                alt="Data Visualization with Tableau" className="h-full w-full" /></div>
                                        <span
                                ...
                                <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                                    ...
                                    <div className="w-full">
                                        <h6 className="mb-1 font-semibold sm:max-w-[75%]">Data Visualization with Tableau
                                        </h6>
                        ...
                        <div className="border">
                            <div className="w-full max-w-3xl gap-x-4 sm:flex">
                                ...
                                <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                                    ...
                                    <div className="w-full">
                                        <h6 className="mb-1 font-semibold sm:max-w-[75%]">Building Real-Time Applications
                                            with Socket.IO</h6>
                        ...
                        <div className="border">
                            <div className="w-full max-w-3xl gap-x-4 sm:flex">
                                ...
                                <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                                    ...
                                    <div className="w-full">
                                        <h6 className="mb-1 font-semibold sm:max-w-[75%]">Advanced CSS: Animations and
                                            Transitions</h6>
...
export default ChanelPlaylistVideopg
