                                        ...
                                        <div className="flex flex-wrap gap-4 pb-4 pt-6"><span
                                            ...
                                            <div className="inline-block">
                                                <div className="inline-flex min-w-[145px] justify-end">
                                                    ...
                                                    </span><span className="group-focus/btn:hidden">Likes</span><span
                                                        className="hidden group-focus/btn:block">Likes</span></button> */}
                                                        </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="flex w-full justify-between">
                                                ...
                                                <div className="block"><button
                                                    className="group/btn px-3 py-2 text-black bg-[#ae7aff] focus:bg-white"><span
                                                        className="group-focus/btn:hidden">Likes</span><span
                                                            className="hidden group-focus/btn:inline">Likes</span></button></div>
                                            </div>
                                            <div className="flex w-full justify-between">
                                                <div className="flex items-center gap-x-2">
                                                    <div className="h-14 w-14 shrink-0"><img
